...
# Business location data obtained from Professor Jensen
...
target_crime_incidence <- crime_incidence
...
dat_target_and_mirror_sf <- dat_crime
...
dat_target_and_mirror <- dat_final

remove(dat_crime, dat_final, mapTheme, nn_function, plotTheme)

save.image("~/UPENN/Box Sync/WISE FELLOWSHIP FALL/FINAL_R_CODE/Environments/Environment_Target_and_Mirror_Datasets.RData")
