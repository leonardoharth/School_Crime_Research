...
# Run a T-test
ttest_propertycrime_nearelementaryschool_target <- t.test(Paired_crime_index$Near_elementarySchool, Paired_crime_index$Not_Near_elementarySchool, paired = TRUE)
