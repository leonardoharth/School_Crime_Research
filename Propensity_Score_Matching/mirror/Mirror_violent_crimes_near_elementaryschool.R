...
# Run a T-test
ttest_violentcrime_nearelementaryschool_mirror <- t.test(Paired_crime_index$Near_elementaryschool, Paired_crime_index$Not_Near_elementaryschool, paired = TRUE)
